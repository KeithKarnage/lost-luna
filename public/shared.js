...
en.tgt=null}},lasers=['red','orange','blue','yellow','purple','pink'],Laser=(o)=>{let O=new Obj();O.init=(o)=>{O.typ=o.typ;O.time=o.time||now();O.x=o.x;O.y=o.y;O.w=o.w;O.h=o.h;field.addChild(O)}
